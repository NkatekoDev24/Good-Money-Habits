...
public class OverallPart3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Part 3 Assessment Response");
    ...
    private void submitDataToFirebase() {
        ...
        if (entryId != null) {
            databaseReference.child(entryId).setValue(formData)
                    .addOnSuccessListener(aVoid -> showDialogWithAction("Success", "Your response has been submitted successfully!", true))
    ...
    private void showDialogWithAction(String title, String message, boolean navigateNext) {
        new AlertDialog.Builder(this)
                .setTitle(title)
                .setMessage(message)
