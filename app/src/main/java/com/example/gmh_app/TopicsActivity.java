...
public class TopicsActivity extends AppCompatActivity {
    ...
    private void updateCardVisibility() {
        ...
        cardOrientation.setEnabled(true); // Orientation is always enabled
        cardInflows.setEnabled(isOrientationComplete); // Unlock after Orientation is complete
        cardOutflows.setEnabled(isInflowsComplete); // Unlock after Inflows is complete
        cardProfit.setEnabled(isOutflowsComplete); // Unlock after Outflows is complete
    }
